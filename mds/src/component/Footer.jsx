...
const navigation = {
	...
	social: [
		{
			name: 'Facebook',
			href: 'https://www.facebook.com/profile.php?id=61574256996275',
			icon: (props) => (
		...
		{
			name: 'Instagram',
			href: 'https://www.instagram.com/mydivinestay/',
			icon: (props) => (
				<svg fill="currentColor" viewBox="0 0 24 24" {...props}>
					<path
						fillRule="evenodd"
		...
		{
			name: 'LinkdIN',
			href: 'https://www.linkedin.com/company/mydivinestays/about/',
			icon: (props) => (
