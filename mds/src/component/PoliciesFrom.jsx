...
const PrivacyPolicyForm = ({ propertyId, onComplete }) => {
    ...
    const [newCustomPolicy, setNewCustomPolicy] = useState({ title: '', description: '' });
    ...
    const handleSave = async () => {
        try {
            await dispatch(createOrUpdatePrivacyPolicy({
                propertyId,
                data: formData
            })).unwrap();
    ...
    const handleSectionUpdate = async (section) => {
        try {
            ...
            if (section === 'cancellationPolicy') {
                ...
                await dispatch(updatePrivacyPolicySection({
                    propertyId,
                    section,
                    data: sectionData
                })).unwrap();
    ...
    const handleAddCustomPolicy = async () => {
        try {
            ...
            if (editingPolicy) {
                ...
                await dispatch(updateCustomPolicy({
                    propertyId,
                ...
                // Add new policy
                await dispatch(addCustomPolicy({
                    propertyId,
                    title: newCustomPolicy.title,
                    description: newCustomPolicy.description
                })).unwrap();
    ...
    const handleDeleteCustomPolicy = async (policyId) => {
        try {
            if (window.confirm('Are you sure you want to delete this policy?')) {
                await dispatch(deleteCustomPolicy({
                    propertyId,
                    policyId
                })).unwrap();
        ...
        <div className="p-4 sm:p-6 lg:p-8">
            ...
            "& .MuiOutlinedInput-root": {
                  ...
                  color: "secondary.main",
                            ...
                            <div className="flex items-center justify-between p-4 border rounded-lg">
                                ...
                                <Switch
                                    ...
                                    onChange={(e) => handleInputChange('checkInCheckOut', 'has24HourCheckIn', e.target.checked)}
                                    color="primary"
                                />
                            </div>
                    ...
                    <TabPanel value={activeTab} index={1}>
                        <div className="space-y-6">
                            <div>
                                ...
                                <Typography variant="body2" className="text-gray-600 mb-4">
                                    Offering a flexible cancellation policy helps travellers book in advance.
                                </Typography>
                            </div>
                            ...
                            <FormControl component="fieldset" className="w-full">
                                ...
                                >
                                    {cancellationOptions.map((option) => (
                                        <Paper
                                            key={option.value}
                                            className={`p-4 border-2 transition-all duration-200 cursor-pointer ${formData.cancellationPolicy === option.value
              ...
              <div className="mt-3 ml-10">
                ...
                <div className="text-center text-xs text-gray-600 mt-1">100% Refund</div>
              </div>
            )} */}
                                        </Paper>
                                    ))}
                                    {/* Custom Hours Option */}
                                    <Paper
                                        className={`p-4 border-2 transition-all duration-200 cursor-pointer ${formData.cancellationPolicy === 'free_cancellation_custom'
                                                ? 'border-blue-500 bg-blue-50'
                                                : 'border-gray-200 hover:border-blue-300 hover:bg-blue-25'
                                            }`}
                                        elevation={0}
                                            ...
                                            label={
                                                <div className="flex items-center justify-between w-full">
                                                    <div className="flex items-center">
                                                        ...
                                                        <div>
                                                            <div className="text-gray-800 font-medium">Custom Cancellation</div>
                                                            <div className="text-sm text-gray-500">Set your own cancellation hours</div>
                                                        </div>
                                                    </div>
                                                </div>
                                            }
                                                ...
                                                <div className="flex items-center space-x-2">
                                                    <TextField
                                                        ...
                                                        onChange={(e) => setFormData(prev => ({
                                                            ...prev,
                                                            customCancellationHours: parseInt(e.target.value) || ''
                                                        }))}
                                                        inputProps={{ min: 1, max: 168 }}
                                                        size="small"
                                                        className="w-60"
                                                    />
                                                    <span className="text-sm ms-2 text-gray-600">hours</span>
                                                </div>
                                                <div className="text-xs text-gray-500 mt-1">
                                                    Enter hours (1-168). Example: 24 for 24 hours before check-in
                                                </div>
                    ...
                    <TabPanel value={activeTab} index={2}>
                        <div className="space-y-6">
                            <div>
                                ...
                                <Typography variant="body2" className="text-gray-600 mb-4">
                                    Add property rules based on the requirement of your property listing
                                </Typography>
                            </div>
                            ...
                            <Paper className="border border-gray-200" elevation={0}>
                                ...
                                <div className="divide-y divide-gray-200">
                                    <div className="p-4 flex flex-col sm:flex-row sm:justify-between sm:items-center gap-4">
                                        ...
                                        <RadioGroup
                                            row
                                            value={formData.propertyRules?.guestProfile?.allowUnmarriedCouples}
                                            onChange={(e) => handleNestedInputChange('propertyRules', 'guestProfile', 'allowUnmarriedCouples', e.target.value === 'true')}
                                            className="gap-4"
                                        >
                                    ...
                                    <div className="p-4 flex flex-col sm:flex-row sm:justify-between sm:items-center gap-4">
                                        ...
                                        <RadioGroup
                                            row
                                            value={formData.propertyRules?.guestProfile?.allowGuestsBelow18}
                                            onChange={(e) => handleNestedInputChange('propertyRules', 'guestProfile', 'allowGuestsBelow18', e.target.value === 'true')}
                                            className="gap-4"
                                        >
                                            <FormControlLabel value={false} control={<Radio size="small" />} label="No" />
                                            <FormControlLabel value={true} control={<Radio size="small" />} label="Yes" />
                                    ...
                                    <div className="p-4 flex flex-col sm:flex-row sm:justify-between sm:items-center gap-4">
                                        ...
                                        <RadioGroup
                                            row
                                            value={formData.propertyRules?.guestProfile?.allowOnlyMaleGuests}
                                            onChange={(e) => handleNestedInputChange('propertyRules', 'guestProfile', 'allowOnlyMaleGuests', e.target.value === 'true')}
                                            className="gap-4"
                                        >
                                            <FormControlLabel value={false} control={<Radio size="small" />} label="No" />
                                            <FormControlLabel value={true} control={<Radio size="small" />} label="Yes" />
                                ...
                                <div className="p-4 space-y-4">
                                    <FormControl fullWidth>
                                        ...
                                        <Select
                                            ...
                                            input={<OutlinedInput label="Acceptable Identity Proofs" />}
                                        ...
                                        >
                                            {identityProofOptions.map((option) => (
                                                <MenuItem key={option.value} value={option.value}>
                                                    <Checkbox
                                                        checked={(formData.propertyRules?.acceptableIdentityProofs || []).indexOf(option.value) > -1}
                                                    />
                                                    {option.label}
                                                </MenuItem>
                                            ))}
                    ...
                    <TabPanel value={activeTab} index={3}>
                        <div className="space-y-6">
                            <div>
                                ...
                                <Typography variant="body2" className="text-gray-600 mb-4">
                                    Set restrictions for food, alcohol, smoking, and noise at your property
                                </Typography>
                            </div>
                        ...
                        <div className="space-y-6">
                            ...
                            <div className="flex items-center justify-between">
                                ...
                                <Switch
                                    ...
                                    onChange={(e) => handleInputChange('petPolicy', 'petsAllowed', e.target.checked)}
                                    color="primary"
                                />
                            </div>
                            ...
                            <Paper className="border border-gray-200" elevation={0}>
                                <div className="flex justify-between items-center p-4 bg-gray-50 border-b border-gray-200">
                                    ...
                                    <Switch
                                        ...
                                        onChange={(e) => handleNestedInputChange('mealPrices', 'breakfast', 'available', e.target.checked)}
                                        color="primary"
                                    />
                                </div>
                                {formData.mealPrices?.breakfast?.available && (
                                    <div className="p-4 space-y-4">
                                        <TextField
                                            ...
                                            onChange={(e) => handleNestedInputChange('mealPrices', 'breakfast', 'price', parseInt(e.target.value) || 0)}
                                            InputProps={{
                            ...
                            <Paper className="border border-gray-200" elevation={0}>
                                <div className="flex justify-between items-center p-4 bg-gray-50 border-b border-gray-200">
                                    ...
                                    <Switch
                                        ...
                                        onChange={(e) => handleNestedInputChange('mealPrices', 'lunch', 'available', e.target.checked)}
                                        color="primary"
                                    />
                                </div>
                                {formData.mealPrices?.lunch?.available && (
                                    <div className="p-4 space-y-4">
                                        <TextField
                                            ...
                                            onChange={(e) => handleNestedInputChange('mealPrices', 'lunch', 'price', parseInt(e.target.value) || 0)}
                                            InputProps={{
                                                startAdornment: <Typography>₹</Typography>,
                                            }}
                                        />
                            ...
                            <Paper className="border border-gray-200" elevation={0}>
                                <div className="flex justify-between items-center p-4 bg-gray-50 border-b border-gray-200">
                                    ...
                                    <Switch
                                        ...
                                        onChange={(e) => handleNestedInputChange('mealPrices', 'dinner', 'available', e.target.checked)}
                                        color="primary"
                                    />
                                </div>
                                {formData.mealPrices?.dinner?.available && (
                                    <div className="p-4 space-y-4">
                                        <TextField
                                            ...
                                            onChange={(e) => handleNestedInputChange('mealPrices', 'dinner', 'price', parseInt(e.target.value) || 0)}
                                            InputProps={{
                                                startAdornment: <Typography>₹</Typography>,
                                            }}
                                        />
